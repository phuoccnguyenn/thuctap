...
if(isset($_POST['update_profile'])){
   ...
   $update_profile = $conn->prepare("UPDATE `users` SET tensv = ?, email = ? WHERE id = ?");
   $update_profile->execute([$tensv, $email, $admin_id]);
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="tensv" value="<?= $fetch_profile['tensv']; ?>" placeholder="update username" required class="box">
            <span>Email :</span>
